...
```
- 由于忘了截图就顺便找了张图
![checksec 检查截图](<img src="../img/pwn1.png">)
...
![dog()反编译截图](<img src="../img/pwn3.png">)

- ok啊,非常合理地使用 `gets(s)` 读取输入，未限制输入长度
- 再让我们看看dog()的栈结构
    
![dog()的栈结构截图](<img src="../img/pwn4.png">)
...
![EXP脚本截图](<img src="../img/pwn6.png">)


## 4. 运行 EXP 并获取 Flag

![getshell截图](<img src="../img/pwn7.png">)
